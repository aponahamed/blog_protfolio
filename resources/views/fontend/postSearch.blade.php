      ...
      <div class="col-md-9">
        <div class="row my-4 ml-4">
            <div class="col-md-12 my-5 text-left">
              <div class="mt-4 mx-4">
                <h2 style="font-size: 50px;color:#26A356;">{{$title}}</h2>
         ...
         <div>
            ...
            <div class="col-md-12">
              ...
              @foreach($recent_post as $value)
                <div class="col-md-6">
                  <div>
                    <img class="img-fluid" src="{{asset('upload/post/featuredImage/'.$value['featuredImage'])}}" style="" alt="{{$value['featuredImage']}}">
                  </div>
                  <div class="mb-2">
                  ...
                  <div>
                    ...
                    {{Str::limit(strip_tags($value['post_description']),150)}}<a href="{{'/blog/'.$value['post_tag']}}" class="btn" style="background-color:#26A356;color:#fff;padding: 2px;">Read More</a >
                    </p>
                  </div>
                </div>
                @endforeach
