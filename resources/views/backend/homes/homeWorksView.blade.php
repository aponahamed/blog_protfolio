            ...
            <div class="card card-primary card-outline">
              <div class="card-body" style="font-size:18px; font-style: italic; font-weight: normal;">
                <h5 class="card-title text-danger"><b></b></h5>
                    ...
                    <form action="{{url('/admin/home/works/Update/'.$homeWorks->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row" style="color:#083749">
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Title</label>
                                <input type="text" name="works_title" class="form-control" value="{{$homeWorks->works_title}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sub Title</label>
                                <input type="text" name="works_sub_title" class="form-control" value="{{$homeWorks->works_sub_title}}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-select form-control" name="works_rattings" aria-label="Default select example">
                                    <option value="{{$homeWorks->works_rattings}}">{{$homeWorks->works_rattings}}</option>
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <div class="form-group mt-3">
                                <img src="{{asset('gallery/'.$homeWorks->homeWorksImage)}}" alt="Avatar" style="width:160px;height:100px;border-radius: 3%;">
                            </div>
